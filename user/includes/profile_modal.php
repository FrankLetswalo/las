    ...
    <div class="modal-dialog">
        <div class="modal-content">
              ...
              <div class="form-group">
                  	<label for="email" class="col-sm-3 control-label">Student No.</label>

                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="email" name="email" value="<?php echo $admin['student_no']; ?>" readonly>
                  	</div>
                </div>
                <div class="form-group">
                  	<label for="email" class="col-sm-3 control-label">Course</label>

                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="email" name="email" value="<?php echo $admin['course_code']; ?>" readonly>
                  	</div>
                </div>
          		  <div class="form-group">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="lastname" name="contact" value="<?php echo $admin['contact_no']; ?>">
                  	</div>
                </div>
