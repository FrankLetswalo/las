        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="course_add.php">
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Total No. of current students</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="category_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_name" class="col-sm-3 control-label">Course Code</label>
                ...
                <div class="form-group">
                    <label for="edit_name" class="col-sm-3 control-label">Course Name</label>
                ...
                <div class="form-group">
                    <label for="edit_name" class="col-sm-3 control-label">No. of Students</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_num" name="no_students">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
